...
|---|---|---|
| Build | Clean Release VST3 and Standalone builds | [Windows Release CI run #8](https://github.com/idkanonto/samplerthingidk/actions/runs/33788048166) at `c4c93e9` built the Release VST3 and test targets, passed CTest, verified the bundle/module, and uploaded the artifact; Standalone was not built in this run |
...
| Random region | Starts always within manual Start/End | Run #8 tested marker clamping/order, invalid restore, Random Start at 0/50/100%, extreme regions, interpolation bounds, natural endings, and forward/reverse region reads; UI compiled but was not DAW interaction-tested |
...
| Realtime | No I/O, blocking, allocation/reclamation, or stretch prep in callback | Immutable waveform peaks, snapshots, region math, and deferred control-thread reclamation code-inspected at `c4c93e9`; profiler/stress test not run |
