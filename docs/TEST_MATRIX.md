...
|---|---|---|
| Build | Clean Release VST3 and Standalone builds | [Windows Release CI run #29](https://github.com/idkanonto/samplerthingidk/actions/runs/33936111067) at `7812104` built the Release VST3 and test targets, passed CTest, verified the bundle/module and license resources, and uploaded the inspected artifact with SHA-256 `b8378fde5a016696f1219f75437621c9b8f2b0e0841de317384a6a872752beae`; Standalone was not built in this run |
...
| Realtime | No I/O, blocking, allocation/reclamation, or stretch prep in callback | Fixed-size Step Mask/Chance decisions, an audio-thread-owned cursor, atomic mask/reset publication, zero render-time RNG, fixed voice storage, immutable prepared data, background stretch publication, and deferred control-thread reclamation were code-inspected at `7812104`; applicable behavior passed run #29, but a profiler/stress test was not run |
