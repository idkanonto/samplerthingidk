...
A 16-voice JUCE VST3/standalone sampler instrument. Every MIDI note chooses a weighted random source and a random legal start point. The current V2 build adds manual harmonic pitch controls and per-source 0.5x–2.0x pitch-preserving Stretch for WAV, AIFF/AIF, MP3, and FLAC sources.
...
- Event processing, Final Length/voice modes, Step Mask, Take History, and master digital processing remain in later gated V2 phases.
